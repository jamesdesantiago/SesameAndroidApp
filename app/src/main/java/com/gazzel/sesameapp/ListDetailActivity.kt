...
import com.gazzel.sesameapp.listdetail.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            SesameAppTheme {
                ...
                val viewModel: ListDetailViewModel by viewModels {
                    ListDetailViewModelFactory(listId, initialName, listService) { getValidToken() }
                }
...
@Composable
fun DetailScreen(viewModel: ListDetailViewModel) {
            ...
            Column {
                ListDetailTopBar(
                    ...
                    onAddCollaboratorClick = {
                        ...
                        Log.d("ListDetail", "Add collaborator clicked")
                    },
                    onShareListClick = {
                        sharingList = true
                    },
                    ...
                    NoteEditor(
                        ...
                        onSave = {
                            ...
                            if (placeIdToUpdate == null) {
                                ...
                                viewModel.setErrorMessage("Error: No place selected to update")
                                editingNotesPlaceId = null
                                currentNote = ""
                                return@NoteEditor
                            }
                            ...
                            viewModel.updatePlaceNotes(placeIdToUpdate, noteToUpdate)
                ...
                if (sharingPlaceId != null) {
                    ...
                    Box(
                        modifier = Modifier
                            .fillMaxSize()
                            .clickable(
                                onClick = { sharingPlaceId = null }, // Dismiss on outside click
                                indication = null, // No ripple effect
                                interactionSource = remember { MutableInteractionSource() }
                            ),
                        contentAlignment = Alignment.BottomCenter // Ensure overlay is at the bottom
                    ) {
                        SharePlaceOverlay(
                            listId = detail.id,
                            place = place,
                ...
                if (sharingList) {
                    Box(
                        modifier = Modifier
                            .fillMaxSize()
                            .clickable(
                                onClick = { sharingList = false }, // Dismiss on outside click
                                indication = null, // No ripple effect
                                interactionSource = remember { MutableInteractionSource() }
                            ),
                        contentAlignment = Alignment.BottomCenter // Ensure overlay is at the bottom
